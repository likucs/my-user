...
#RUN git clone -b main https://github.com/likucs/my-user /root/userbot
#RUN mkdir /root/userbot/bin/
#WORKDIR /root/userbot/
#RUN chmod +x /usr/local/bin/*
RUN wget https://raw.githubusercontent.com/likucs/my-user/main/sh1vamrun.py
RUN wget https://raw.githubusercontent.com/likucs/my-user/main/requirements.txt
